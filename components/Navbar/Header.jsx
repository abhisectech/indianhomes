  ...
  const MegaMenuModularKitchenContent = () => (
    <div className='bg-white shadow-2xl rounded-lg p-4  flex absolute w-full h-fit text-black'
      ...
      <div className='flex'>
        <div className=''>
          <div className=''>
            <h1 className='text-4xl font-bold md:text-lg' style={{ width: '350px' }}>Modular Kitchen Largest Manufacturers</h1>
          ...
          <div className=''>
            <ul className='nav-item'>
              ...
              <div className='flex gap-2'>
                ...
                <div>
                  <Link href="/modular-kitchen-types"><h3 className='text-base font-extrabold bg-black text-white center pl-2 ' onMouseOver={() => handleMouseOverImage('type')}>Types of Modular Kitchen</h3></Link>
        ...
        <div className='flex -ml-40'>
          ...
          <div className='ml-2 nav-item'>
            ...
            <div className='flex gap-2 '>
              ...
              <div>
                <Link href="/lacquer-glass-wardrobe-designs"><h3 className='text-base font-extrabold px-2 py-1  text-white bg-black' onMouseOver={() => handleMouseOverImage('glass_wardrobe')}>Lacquer Glass Wardrobe Designs</h3></Link>
        ...
        >
          ...
          <div className="animated-bg text-black absolute sticky top-0 ">
            <div className="flex justify-center gap-80 ">
              <div className="flex ml-0 gap-1">
                ...
                <h1 className="text-xs text-black font-bold mt-2"> <a href='tel:+919899264978'>Call Us</a> </h1>
              </div>
              <div className="flex gap-4 md:text-xs text-black mt-2">
                <Link href="/book-a-interior-design-visit"> <p>Book a Visit</p></Link>
                <p><Link href="/book-a-interior-design-visit">| Refer a Rewards</Link></p>
     
                <p>| <Link href="/collaborate-with-architects-interior-designers">Architects & Interior Designers</Link></p>
              </div>
              <div className='flex gap-1 py-1'>
                <a href="https://www.instagram.com/designindiankitchen/?hl=en" target='_blank'>
                  <SocialIcon
                    network="instagram"
                    style={{ width: '1.5rem', height: '1.5rem', }}
                  />
                </a>
                <a href="https://www.youtube.com/channel/UCqkIRwI6EL9QmaTZHYm6Hug" target="_blank">
                  <SocialIcon
                    network="youtube"
          ...
          >
            ...
            <div className="sm:px-0 md:px-0 xl:px-1 xl:px-0 ">
              <nav className="flex flex-wrap xl:flex-nowrap justify-center items-center mt-4 text-black font-bold space-x-4 sm:space-x-5" style={{ justifyContent: 'center' }}>
                <p className=" flex center text-sm font-bold" onMouseOver={() => handleMouseOver('DesignIdeas')}>
                  <Link href="/modular-interior-design-ideas"> Design Ideas</Link>
                ...
                <Link href="/GetQuote"> <button className="bg-yellow-400 text-sm py-2 px-2 rounded-full -mt-4 center mb-1">Get Quotes</button>
                </Link>
                <button className=' text-sm py-2 px-4 mb-1' style={{ alignItems: 'center', borderRadius: '50px', border: '1px solid black', marginBottom: '7px' }}><Link href="/book-a-interior-design-visit">Contact</Link></button>
