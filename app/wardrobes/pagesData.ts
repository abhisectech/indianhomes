export const pagesData = [
  ...
  {
    id: 3,
    name: 'Wardrobe Renovation Services',
    slug: 'wardrobe-renovation-services',
    noItems: '162',
    heading: 'Wardrobe Renovation Services',
